...
stargazer::stargazer(
  ...
  title = "Linear model to describe each performance metric. Standard deviations in parentheses.")
```
...
ggplot(df.metrics.absolute, aes(x = metric, y = strategy, fill = rescaled, label = label)) + 
  ...
  ggtitle("Method ranking by predicted performance, averaging folds.", 
          subtitle = "Lower ranks are better. Expected performances in brackets.")
```
