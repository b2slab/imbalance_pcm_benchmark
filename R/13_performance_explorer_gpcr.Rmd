---
title: "Exploring GPCR performance"
...
**The text in this document is the original one (kinases), some conclusions might have changed!**
...
df.raw <- read.csv("performances/ratios_df_rdm_baseline_gpcr.csv")
...
```{r}
write.csv(df.clean, file = "data-interim/ratios_df_clean_gpcr.csv")
```
